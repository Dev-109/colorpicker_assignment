...
## History
The color palette Api was implemented to the Android studio starting from API level 24. The Api is included in the Android support library. The package is: android.support.*
